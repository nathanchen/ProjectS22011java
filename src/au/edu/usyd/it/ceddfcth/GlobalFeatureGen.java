...
public class GlobalFeatureGen 
{
	...
	/*
	 * Generate global features (cedd and fcth) for each image
	 * 
	 * input:
	 * @param: fileDir -> directory stores keyframe
	 * output:
	 * @param: outputFile -> output ".cedd" and ".fcth" files for each frame to subdirectoty of 'fileDir' called "globalFeatures"
	 * 
	 * */
	public void generateGlobalFeatures(String fileDir)
	{
		File file = new File(fileDir);
		System.out.println("Generating global features...");
