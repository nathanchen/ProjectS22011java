...
public class GlobalFeatureKmeansMoveFrames 
{
	...
	public void globalFeatureKmeansMoveFrames(String originDir, String clusterDir, int NUMCLUSTERS) 
	{
		try
		{
			for(int i = 0; i <= NUMCLUSTERS; i++)
			{
				String str = clusterDir + i + "/";
...
//				2009-06-01(Mon)PM070000-ABC1_DTV2-0fd3d00f.mp4_167_1.jpg
				for(String s : dir.list())
				{
					...
					while(n <= 3)
					{
						...
						n++;
						File ori = new File(originDir + frameName);
